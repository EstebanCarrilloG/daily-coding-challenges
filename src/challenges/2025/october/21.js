 ...
 * returns a string indicating how to adjust the room temperature based on these constraints.
 *
 * @param {number} currentF - The current temperature in Fahrenheit.
 * @param {number} targetC - The target temperature in Celsius.
